...
<template>
  <div id="app">
    <JumbotronComponent Title="Team 8297 the WIHI Robowolves"
      ...
      HasImage Image="/robo-site-testing/images/teampicture.jpg" HasButton Button="Our Mission"
      Link="/robo-site-testing/mission" />
    ...
    <div class="home">
      ...
      <router-link class="sponsor-us" to="/robo-site-testing/sponsors"> Sponsor Us!</router-link>
