...
<template>
  <div id="app">
    <JumbotronComponent Title="Team 8297 the WIHI Robowolves"
      ...
      HasImage Image="/wihirobotics.org/images/teampicture.jpg" HasButton Button="Our Mission"
      Link="/wihirobotics.org/mission" />
    ...
    <div class="home">
      ...
      <router-link class="sponsor-us" to="/wihirobotics.org/sponsors"> Sponsor Us!</router-link>
